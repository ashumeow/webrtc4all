...
MIDL_DEFINE_GUID(IID, IID_IPluginInstance,0xACE5665C,0xBA38,0x4935,0x8D,0x73,0x2E,0x36,0x93,0xED,0x68,0x99);
...
MIDL_DEFINE_GUID(CLSID, CLSID_pluginInstance,0x69E4A9D1,0x824C,0x40DA,0x96,0x80,0xC7,0x42,0x4A,0x27,0xB6,0xA0);
